...
class teachers(object):
    ...
    def update_teacher(self, teacherId, firstname, lastname, email, password):
        try:
            conn = sqlite3.connect('test.db')
            ...
            str_update += " WHERE " + self.__teacherId + "=" + "'" + str(teacherId) + "'"
            print(str_update)
