...
class basketball_lesson_student(tkinter.Toplevel):
    ...
    def book_lesson(self, event):
        ...
        if "booked" not in current_tags:
            ...
            if response == 'yes':
                arr_insert = ["insert_grouptime_to_student", "basketball", row[0], row[1], row[2], row[3],
            ...
            if response == 'yes':
                arr_delete = ["delete_grouptime_to_student", "basketball", row[0], row[1], row[2], row[3],
                              self.firstname, self.lastname]
                print(arr_delete)
