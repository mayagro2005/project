...
class Payments(tkinter.Toplevel):
    ...
    def create_gui(self):
        self.lbl_welcome = Label(self, text="Hello! This is your payment box", bg="#19A7CE", fg="black",
                                 font=("Arial", 20, "bold"),relief="solid", bd=3)
        self.lbl_welcome.place(x=100, y=20)

        self.lbl_price = Label(self, text="The price for a year is 1500 shekels", bg="#19A7CE", fg="black",
