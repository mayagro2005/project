...
class ping_pong_lesson_student(tkinter.Toplevel):
    def __init__(self, parent, firstname, lastname):
        super().__init__(parent)
        self.parent = parent
        self.title('PING PONG LESSON WINDOW')
    ...
    def show_info(self):
        ...
        self.parent.parent.parent.send_msg("ping pong", self.parent.parent.parent.client_socket)
    ...
    def book_lesson(self, event):
        ...
        if "booked" not in current_tags:
            ...
            if response == 'yes':
                arr_insert = ["insert_grouptime_to_student", "ping pong", row[0], row[1], row[2], row[3],
            ...
            if response == 'yes':
                arr_delete = ["delete_grouptime_to_student", "ping pong", row[0], row[1], row[2], row[3],
                              self.firstname, self.lastname]
                print(arr_delete)
